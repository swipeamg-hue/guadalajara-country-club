 ...
 * para cada una de las 5 áreas del Guadalajara Country Club.
 */
  ...
  demo: {
    render: (containerId) => {
      ...
      document.getElementById("demo-booking-form").addEventListener("submit", (e) => {
        ...
        const textMessage = `¡Hola! Me gustaría agendar una demostración de productos Swipe en el Guadalajara Country Club para el área de *${areaSelected}*.\n\n📅 *Fecha propuesta:* ${formattedDate}\n⏰ *Horario:* ${timeVal}`;
